...
navList.forEach((item, index) => {
    item.addEventListener("click", function () {
        // Your navigation and section toggling code

        if (this.getAttribute("href") === "#contact") {
            // Enable the footer by removing the 'disabled' attribute
            footer.removeAttribute("disabled");
        } else {
            // Disable the footer by adding the 'disabled' attribute
